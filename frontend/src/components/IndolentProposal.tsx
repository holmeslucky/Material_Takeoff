...
interface IndolentProposalProps {
  projectId: string
  projectName: string
...
export default function IndolentProposal({ 
  projectId, 
  projectName, 
  onProposalGenerated 
}: IndolentProposalProps) {
      ...
      case 'proposal':
        return (
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-3xl font-bold text-white">Indolent Forge Proposal</h3>
                  ...
                  <button 
                    onClick={() => {
                      if (proposalData) {
                        ...
                        const body = `Please find attached the proposal for project: ${projectName}`
    ...
    <div className="h-full flex flex-col bg-gray-950">
      ...
      <div className="bg-gray-900 border-b border-gray-800 p-4">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-white">Indolent Forge Proposal Engine</h2>
            <p className="text-gray-400">Indolent Designs - Lazy by Name, Relentless by Nature</p>
            <p className="text-xs text-gray-500">Professional Steel Fabrication Proposals</p>
          </div>
        </div>
